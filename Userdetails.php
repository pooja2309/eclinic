   ...
   <img src="elogo.png" alt="Img Not available" align="right" height="55" width="80">
      <?php
         if(isset($_POST['select'])) {
            ...
            $sql = "SELECT Name,Phone_number,Name,Email,Address,Username,DOB FROM Users WHERE Username = '$Username'" ;
...
<?php
	...
	?></table> </center><br/><div id="center_button">
    	    <center><button onclick="location.href='check.html'">LogOut</button>   </center>
	    <center><button onclick="location.href='Userdelete.php'">Delete my account</button>  </center>
	    <center><button onclick="location.href='Userupdate.php'">Update my account</button>   </center> 
	<?php       
