 ...
 background-blend-mode: overlay;
   ...
   <img src="elogo.png" alt="Img Not available" align="right" height="55" width="80">
	...
	$DOB = $_POST['DOB'];
            ...
            $sql = "SELECT DISTINCT d.Name,a.DocUsername,d.Phone,Clinic,Dates,Time_slot FROM Doctors d,appointment a,Users p WHERE a.PatientUsername='$Username' AND d.DocUsername=a.DocUsername" ;
...
<br/><div id="center_button">
 <br/><div id="center_button">
	    <center><button onclick="location.href='Delapp.php'">Delete appointment</button>   </center>
