...
$Phone = ($_POST['Phone']);
$DOB= ($_POST['DOB']);
$sql = "SELECT Name,DocUsername FROM Doctors WHERE DocUsername='$Username' AND Phone='$Phone' AND DOB='$DOB'" ;               
...
$sql = "SELECT * FROM Doctors WHERE DocUsername='$Username'";
...
<br/><br/></br></br><div>
<center><button onclick="location.href='DocCheckapp.php'">Check my Appointments</button></center> </br>
<center><button onclick="location.href='Settimeslot.php'">Set Availability</button> </center></br>
<center><button onclick="location.href='Deltimeslot.php'">Delete Timeslots</button> </center></br>
